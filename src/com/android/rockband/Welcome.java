...
public class Welcome extends Activity implements OnTouchListener, OnClickListener {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
    	...
    	case R.id.properties:
    		...
    		propertiesIntent.setClass(Welcome.this, Preferences.class);
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case R.id.dlcButton:
			if(event.getAction() == MotionEvent.ACTION_UP) {
				...
				dlcIntent.setClass(Welcome.this, DLCSearch.class);
		...
		case R.id.scoresButton:
			if(event.getAction() == MotionEvent.ACTION_UP) {
				...
				scoresIntent.setClass(Welcome.this, LeaderboardSearch.class);
